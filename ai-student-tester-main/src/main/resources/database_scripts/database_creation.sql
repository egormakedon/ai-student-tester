...
CREATE TABLE IF NOT EXISTS AISTUDENTTESTER.QUESTION (
    ...
    QUESTIONNAME    VARCHAR(200) NOT NULL COMMENT 'Question name',
    FIRSTANSWER     VARCHAR(200) NOT NULL COMMENT 'First answer',
    SECONDANSWER    VARCHAR(200) NOT NULL COMMENT 'Second answer',
    THIRDANSWER     VARCHAR(200) NOT NULL COMMENT 'Third answer',
    FOURTHANSWER    VARCHAR(200) NOT NULL COMMENT 'Fourth answer',
    FIFTHANSWER     VARCHAR(200) NOT NULL COMMENT 'Fifth answer',
    RIGHTANSWER     CHAR(1) NOT NULL COMMENT 'Right answer',
    ACTIVEFLAG      CHAR(1) NOT NULL COMMENT 'Active flag',

    PRIMARY KEY(QUESTIONID),
    UNIQUE INDEX QUESTIONNAME_UNIQUE_INDEX (QUESTIONNAME ASC),
...
CREATE TABLE IF NOT EXISTS AISTUDENTTESTER.STUDENTGROUP (
    ...
    STUDENTGROUPNUMBER    VARCHAR(20) NOT NULL COMMENT 'Student group number',
    STUDENTGROUPYEAR      VARCHAR(20) NOT NULL COMMENT 'Student group year',
    ACTIVEFLAG            CHAR(1) NOT NULL COMMENT 'Active flag',
